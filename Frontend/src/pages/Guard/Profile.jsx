  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-3xl mx-auto">
      ...
      <div className="flex flex-col items-center py-8">
        <div className="h-28 w-28 bg-white rounded-[2.5rem] shadow-xl shadow-primary-500/10 border border-gray-100 flex items-center justify-center mb-6 relative group transition-all duration-500 hover:scale-105">
          <User size={56} className="text-primary-600 transition-transform group-hover:scale-110" />
          <div className="absolute -bottom-1 -right-1 h-9 w-9 bg-primary-600 rounded-2xl border-4 border-white flex items-center justify-center text-white shadow-lg">
        ...
        <div className="flex items-center gap-2 mt-2 text-gray-400 font-bold uppercase tracking-widest text-[10px] bg-gray-100 px-3 py-1 rounded-full">
          ...
          <span>{user?.role === 'GUARD' ? 'Security Personnel' : user?.role || 'User'}</span>
        </div>
      </div>

      {/* Unit Info */}
      <div className="space-y-4">
        <h3 className="text-lg font-black text-gray-900 tracking-tight px-1 uppercase text-[11px] tracking-widest text-gray-400">Security Credentials</h3>
        <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden divide-y divide-gray-50">
            <div className="p-5 flex items-center gap-4">
               ...
               <div>
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">System Email</p>
      ...
      <p className="text-center text-[10px] font-black text-gray-300 uppercase tracking-[0.3em] pb-10">
        GateSync v1.0.4 • Security Build
      </p>
